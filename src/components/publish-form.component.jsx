...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        if(e.target.className.includes("disable")) {//disable
            return;
        }
        ...
        if(!tags.length || tags.length > tagLimit) {
            return toast.error(`Enter at least 1 and up to ${ tagLimit} tags that will help us rank your blog`)
        }
        
        let loadingToast = toast.loading("Publishing...");

        e.target.classList.add('disable');//disable
        ...
        .then(() => {
            e.target.classList.remove('disable');//disable

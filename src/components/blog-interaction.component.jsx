        ...
        <Toaster/>
            ...
            <div className='flex gap-6 justify-between'>
                <div className='flex gap-3 items-center'>
                    ...
                    >
                        <i className={"text-2xl fi " + ( islikedByUser ? "fi-sr-heart" : "fi-rr-heart" )}></i>
                    </button>
                    ...
                    >
                        <i className='text-2xl fi fi-rr-comment-dots'></i>
                    </button>
                ...
                <div className='flex gap-6 items-center'>
                    ...
                    <Link to={`https://twitter.com/intent/tweet?text=Read ${title}&url=${location.href}`} className='flex-none w-[25px]'>
                        {/* <i className='fi fi-brands-twitter text-2xl hover:text-twitter'></i> */}
                        <img src={ twitter } className='w-full hover:text-twitter' alt="Logo"/>
                    </Link>
                </div>
            </div>
            <hr className='border-grey my-2' />
